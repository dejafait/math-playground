...
Split 57 lemmas and Corollary 32a out of PROOF.md, preserving their mathematical text and numbering. Moved shared starting inputs to foundations/. Reconstructed direct dependencies in root DAG.md, the sole graph source, including the later results missing from the former overview.
