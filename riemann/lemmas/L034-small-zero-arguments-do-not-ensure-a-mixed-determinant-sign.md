...
**Mathlib.** This explicit counterexample is proved above by exact complex arithmetic; no prepackaged Mathlib proof of the full statement is used. The norm-square identity is `Complex.sq_norm`:
