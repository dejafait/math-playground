...
**Mathlib.** The quadratic-root argument is proved above using `Real.sq_sqrt` and `Real.sqrt_pos`, rather than a prepackaged theorem about these Jensen polynomials:
