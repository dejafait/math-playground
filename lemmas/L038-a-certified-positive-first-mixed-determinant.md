...
**Proof.** `scripts/hankel/certify_hankel.py` implements the explicit four-term theta integrands on [0,2], the eighth-order panel enclosure of Lemma 36, and the common tail of Lemma 35. It uses 70-digit outward arithmetic and the rational π enclosure of Lemma 37. The reproducible command is:
